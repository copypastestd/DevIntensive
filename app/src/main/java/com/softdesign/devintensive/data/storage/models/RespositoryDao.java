...
*/
public class RespositoryDao extends AbstractDao<Respository, Long> {

    public static final String TABLENAME = "REPOSITORIES";

    /**
     * Properties of entity Respository.<br/>
    ...
    */
    ...
    private Query<Respository> user_RespositoriesQuery;

    public RespositoryDao(DaoConfig config) {
        super(config);
    }
    
    public RespositoryDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Respository entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Respository entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(Respository entity) {
    ...
    @Override
    public Respository readEntity(Cursor cursor, int offset) {
        Respository entity = new Respository( //
    ...
    @Override
    public void readEntity(Cursor cursor, Respository entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Respository entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Respository entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    /** Internal query to resolve the "respositories" to-many relationship of User. */
    public List<Respository> _queryUser_Respositories(String userRemoteId) {
        synchronized (this) {
            if (user_RespositoriesQuery == null) {
                QueryBuilder<Respository> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.UserRemoteId.eq(null));
                user_RespositoriesQuery = queryBuilder.build();
            }
        }
        Query<Respository> query = user_RespositoriesQuery.forCurrentThread();
